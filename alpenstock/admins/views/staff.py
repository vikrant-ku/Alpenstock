...
class Add_staff(View):
    def get(self, request):
        if validate_user(request):
            return render(request, 'alpen_admin/add-staff.html')
...
class Edit_staff(View):
    def get(self, request, **kwargs):
        if validate_user(request):
            ...
            return render(request, 'alpen_admin/add-staff.html', data)
        return redirect('login')
...
class All_staff(View):
    ...
    def get(self, request):
        if validate_user(request):
            ...
            # paginator
            paginator = Paginator(all_staff, 1)
            ...
            if page is None:
                ...
                (start_index, end_index) = proper_pagination(allstaff, index=1)
            ...
            return render(request, 'alpen_admin/all-staff.html', data)
        return redirect('login')
